...
final class WebRTCClient: NSObject {
    ...
    private func configureAudioSession() {
        ...
        do {
            try self.rtcAudioSession.setCategory(AVAudioSessionCategoryPlayAndRecord/*AVAudioSession.Category.playAndRecord.rawValue*/)
            try self.rtcAudioSession.setMode(AVAudioSessionModeVoiceChat/*AVAudioSession.Mode.voiceChat.rawValue*/)
        } catch let error {
